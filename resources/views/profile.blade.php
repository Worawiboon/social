        ...
        <div class="row">
            ...
            @if(!empty($posts))
                @foreach($posts as $post)
                    <!-- Posts คือ ตัวที่มีค่ามากกว่า 1 ค่า หรือเก็บค่ามากกกว่า 1 ค่า อาจจะเป็น array หรือเป็นตัวแปรชนิดอื่นๆที่มีการเก็ยค่าหลายๆค่าไว้
post เฉยไม่มี s ตัวแปรที่ใช้วิ่งวนไปเรื่อยๆ คล้ายกับตัวแปร i ใน for ของภาษาซี เช่น for(i=0;i++;i <= posts) {count<<i;} dynamic Programming คือมีการเคลื่อนไหวเปลี่ยนแปลวตามเงื่อนไขต่างๆ static คือ แก้แล้วแก้เลย ไม่เปลี่ยนแปลง เช่น html css-->
                        <div class="card mt-3">
